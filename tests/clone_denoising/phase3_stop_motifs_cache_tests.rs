...
mod stop_motif_cache_tests {
    ...
    fn test_stop_motif_cache_creation() {
        let mut cache = StopMotifCache {
            ...
            mining_stats: MiningStats {
                ...
                total_patterns_found: 1000,
                patterns_above_threshold: 235,
                top_1_percent_contribution: 15.2,
    ...
    fn test_pattern_categorization() {
        ...
        let ast_patterns = [
            ...
            ("class_definition", AstPatternCategory::ClassDeclaration),
        ];
...
mod stop_motif_cache_manager_tests {
    ...
    fn test_cache_manager_initialization() {
        ...
        assert_eq!(manager.cache_directory(), &cache_dir);
        assert!(manager.refresh_policy().auto_refresh_enabled);
        assert_eq!(manager.refresh_policy().max_age_hours, 24);
    }
    ...
    fn test_cache_invalidation_logic() {
        ...
        let refresh_policy = CacheRefreshPolicy {
            ...
            min_codebase_change_threshold: 0.05,
            force_refresh_on_new_languages: true,
        };
        ...
        let python_code_samples = vec![
            ...
            (
                ...
                vec![AstStopMotifEntry {
                    ...
                    category: AstPatternCategory::ControlFlow,
                    language: "python".to_string(),
                    metadata: {
                        let mut map = HashMap::new();
                        map.insert(
    ...
    fn test_javascript_typescript_ast_patterns() {
        let js_ts_patterns = vec![
            ...
            ("javascript", "console.log('debug');\nfunction test() { return 42; }", vec![
                ("console_call", AstPatternCategory::FunctionCall),
...
"#;
        ...
        let expected_rust_patterns = vec![
            ...
            ("match_expression", AstPatternCategory::ControlFlow),
        ];
        ...
        let cache = StopMotifCache {
            ...
            ast_patterns: vec![
                ...
                AstStopMotifEntry {
                    ...
                    idf_score: 0.4,
                    weight_multiplier: 0.2,
                    category: AstPatternCategory::FunctionCall,
    ...
    fn test_cache_refresh_policies() {
        ...
        let policies = vec![
            ...
            CacheRefreshPolicy {
                ...
                max_age_hours: 0,
                min_codebase_change_threshold: 1.0, // Never refresh
                force_refresh_on_new_languages: false,
            },
        ];
