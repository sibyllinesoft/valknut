//! Issue and suggestion code dictionary for analysis output.

use crate::core::pipeline::results::result_types::CodeDefinition;

/// Sanitizes a category name into a short alphanumeric code (max 8 chars).
...
/// Returns the issue code definition for a given category name.
...
/// Pattern matching methods for [`SuggestionEntry`].
impl SuggestionEntry {
    /// Checks if the entry pattern matches the given lowercase kind string.
...
const SUGGESTION_ENTRIES: &[SuggestionEntry] = &[
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("eliminate_duplication"),
        code: "DEDUP",
        title: "Eliminate Duplication",
        summary: "Consolidate repeated logic to a shared helper before it diverges.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("extract_method"),
        code: "XTRMTH",
        title: "Extract Method",
        summary: "Pull focused helpers from large routines to shrink cognitive load.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("extract_class"),
        code: "XTRCLS",
        title: "Extract Class",
        summary: "Split multi-purpose modules into cohesive components.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsAndContains("simplify", "conditional"),
        code: "SIMPCND",
        title: "Simplify Conditionals",
        summary: "Flatten or reorganize complex branching to clarify intent.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_cyclomatic_complexity"),
        code: "RDCYCLEX",
        title: "Reduce Cyclomatic",
        summary: "Break apart dense branching to keep cyclomatic complexity in check.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_cognitive_complexity"),
        code: "RDCOGN",
        title: "Reduce Cognitive",
        summary: "Streamline control flow to ease human comprehension.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_fan_in"),
        code: "RDFANIN",
        title: "Reduce Fan-In",
        summary: "Distribute responsibilities so fewer callers funnel through one hotspot.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_fan_out"),
        code: "RDFANOUT",
        title: "Reduce Fan-Out",
        summary: "Contain dependencies so modules rely on fewer collaborators.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_centrality"),
        code: "RDCNTRL",
        title: "Reduce Centrality",
        summary: "Limit chokepoint responsibilities in the dependency graph.",
    },
    SuggestionEntry {
        pattern: PatternMatch::StartsWith("reduce_chokepoint"),
        code: "RDCHOKE",
        title: "Fix Chokepoint",
        summary: "Split chokepoint modules so change risk is shared.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("nested_branching"),
        code: "RDNEST",
        title: "Reduce Nesting",
        summary: "Flatten nested branching to keep logic approachable.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Exact("simplify_logic"),
        code: "SMPLOGIC",
        title: "Simplify Logic",
        summary: "Clarify logic with smaller expressions or well-named helpers.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("split_responsibilities"),
        code: "SPLRESP",
        title: "Split Responsibilities",
        summary: "Separate distinct concerns into dedicated units.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("move_method"),
        code: "MOVEMTH",
        title: "Move Method",
        summary: "Relocate behavior to the module with the right knowledge.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("organize_imports"),
        code: "ORGIMPT",
        title: "Organize Imports",
        summary: "Tidy imports to highlight the dependencies that matter.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("introduce_facade"),
        code: "FACAD",
        title: "Introduce Facade",
        summary: "Wrap complex subsystems behind a focused interface.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("extract_interface"),
        code: "XTRIFCE",
        title: "Extract Interface",
        summary: "Define interfaces to decouple callers from implementations.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("inline_temp"),
        code: "INLTEMP",
        title: "Inline Temporary",
        summary: "Replace temporary variables with direct expressions to reduce clutter.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("rename_class"),
        code: "RENCLSS",
        title: "Rename Class",
        summary: "Choose a name that conveys the module's real role.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("rename_method"),
        code: "RENMTHD",
        title: "Rename Method",
        summary: "Make intentions clear with well-chosen method names.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("extract_variable"),
        code: "XTRVAR",
        title: "Extract Variable",
        summary: "Introduce named variables to document intent and reuse values.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("add_comments"),
        code: "ADDCMNT",
        title: "Add Comments",
        summary: "Capture the why behind tricky logic paths.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("rename_variable"),
        code: "RENVAR",
        title: "Rename Variable",
        summary: "Rename identifiers so they read like documentation.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("replace_magic_number"),
        code: "REPMAG",
        title: "Replace Magic Number",
        summary: "Bind constants to descriptive names to reveal intent.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("format_code"),
        code: "FMTSTYLE",
        title: "Format Code",
        summary: "Apply consistent formatting to reduce visual noise.",
    },
    SuggestionEntry {
        pattern: PatternMatch::Contains("refactor_code_quality"),
        code: "REFQLTY",
...
/// Returns the suggestion code definition for a given suggestion kind.
...
/// Returns only the code string for a given suggestion kind.
pub fn suggestion_code_for_kind(kind: &str) -> String {
    suggestion_definition_for_kind(kind).code
}

/// Returns only the code string for a given issue category.
