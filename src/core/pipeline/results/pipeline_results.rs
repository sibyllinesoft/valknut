...
/// Factory methods for [`StructureAnalysisResults`].
impl StructureAnalysisResults {
    /// Create results for when structure analysis is disabled.
...
/// Factory methods for [`ComplexityAnalysisResults`].
impl ComplexityAnalysisResults {
    /// Create results for when complexity analysis is disabled.
    pub fn disabled() -> Self {
        Self {
            enabled: false,
...
/// Factory methods for [`RefactoringAnalysisResults`].
impl RefactoringAnalysisResults {
    /// Create results for when refactoring analysis is disabled.
    pub fn disabled() -> Self {
        Self {
            enabled: false,
            detailed_results: Vec::new(),
...
/// Factory methods for [`ImpactAnalysisResults`].
impl ImpactAnalysisResults {
    /// Create results for when impact analysis is disabled.
    pub fn disabled() -> Self {
        Self {
            enabled: false,
...
/// Factory methods for [`LshAnalysisResults`].
...
/// Factory methods for [`CoverageAnalysisResults`].
impl CoverageAnalysisResults {
    /// Create results for when coverage analysis is disabled.
    pub fn disabled() -> Self {
        Self {
            enabled: false,
...
/// Returns 100.0 as default health score for deserialization.
...
/// Summary and accessor methods for [`PipelineResults`].
...
/// Iteration methods for [`ScoringResults`].
impl ScoringResults {
