...
//!
//! Coverage file discovery has been moved to the `coverage_discovery` module.
...
// Re-export coverage discovery types for backward compatibility
pub use crate::core::coverage_discovery::{CoverageDiscovery, CoverageFile, CoverageFormat};

/// Safe file reading with UTF-8 validation and fallback handling
pub struct FileReader;

/// File reading and binary detection methods for [`FileReader`].
impl FileReader {
...
///
/// Each range is a tuple of (start_line, end_line) inclusive.
pub fn ranges_overlap(lhs: (usize, usize), rhs: (usize, usize)) -> bool {
...
// Coverage-related tests moved to coverage_discovery.rs
