//! Report generation functions for various output formats
//!
...
// Note: This module has its own versions of metric_class, severity_indicator,
// effort_class, map_severity_to_sonar, and escape_csv that are HTML-specific
// and different from the generic versions in helpers.rs
