...
impl EdgeCollector {
    ...
    pub async fn finish_request(&self, request: RequestCollector) -> Result<()> {
        // Update stats
        {
            ...
            let processing_time = request.start_time.elapsed()
                .unwrap_or_default()
                .as_micros() as f64;
...
pub mod python {
    ...
    pub fn is_module_boundary(caller_module: &str, callee_module: &str) -> bool {
        ...
        caller_parts.len() > 1 && callee_parts.len() > 1 &&
...
mod tests {
    ...
    fn test_should_sample_partial_rate() {
        ...
        assert!(sample_rate > 0.4 && sample_rate < 0.6, "Sample rate was {}", sample_rate);
    }
    ...
    fn test_python_symbol_formatting_comprehensive() {
        ...
        // Empty function name
        assert_eq!(
            format_python_symbol("test", None, ""),
            "test:"
        );
    ...
    fn test_nodejs_symbol_formatting_comprehensive() {
        ...
        // No extension
        assert_eq!(
            format_nodejs_symbol("src/app", "main"),
            "src.app:main"
        );
        ...
        // Root level file
        assert_eq!(
            format_nodejs_symbol("index.js", "main"),
            "index:main"
        );
    }
    ...
    fn test_nodejs_file_to_module_conversion() {
        ...
        let test_cases = vec![
            ...
            ("relative/path/module.ts", "export", "relative.path.module:export"),
    ...
    fn test_collector_stats_clone() {
        ...
        assert_eq!(stats.avg_processing_time_us, cloned_stats.avg_processing_time_us);
    }
}